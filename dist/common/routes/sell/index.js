...
var Sell = (_dec = (0, _reactRedux.connect)(function (state) {
    return {
        state: state.add
    };
}, function (dispatch) {
    ...
    function Sell(props) {
        ...
        return _possibleConstructorReturn(this, Object.getPrototypeOf(Sell).call(this, props));
    }
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            _fitLayout.Col,
                            { span: '6' },
                            _react2.default.createElement(_fitInput2.default, { onChange: this.handleAddDataChange.bind(this, 'price'),
                                label: '售价' })
                        ),
                        _react2.default.createElement(
                            _fitLayout.Col,
                            { span: '6' },
                            _react2.default.createElement(_fitInput2.default, { onChange: this.handleAddDataChange.bind(this, 'sellDate'),
                                label: '销售日期' })
                        ),
                        _react2.default.createElement(
                            _fitLayout.Col,
                            { span: '6' },
                            _react2.default.createElement(_fitInput2.default, { onChange: this.handleAddDataChange.bind(this, 'sellMember'),
                                label: '销售员' })
                        )
                    )
                ),
